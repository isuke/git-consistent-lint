...
const createGrammer = (_program, templateFilePath, definitionsFilePath) => {
  ...
  const _template = fs.readFileSync(templateFilePath, 'utf8')
...
const parseInput = (_program, templateFilePath, definitionsFilePath) => {
  let input = ''
...
parseInput(program, templateFilePath, definitionsFilePath)
